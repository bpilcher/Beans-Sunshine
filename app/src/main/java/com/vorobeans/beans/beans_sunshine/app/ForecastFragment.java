...
public class ForecastFragment extends Fragment {
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        // action bar will auto-handle clicks on the home/up button...
        // but ONLY if you specify a parent activity in AndroidManifest.xml
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]>
    {
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                ...
                // verify correct URI construction
                Log.v(LOG_TAG, "Built URI: " + builtUri.toString());

                //URL url = new URL("http://api.openweathermap.org/data/2.5/forecast/daily?q=21234&mode=json&units=metric&cnt=7");
        ...
        // attempt to format json data nicely with the provided helper methods
        try
        {
            jsonWeatherData = getWeatherDataFromJson(forecastJsonStr,numDays);
        ...
        protected void onPostExecute(String[] strings) {
            if(jsonWeatherData != null)
            {
                ...
                for(String dayForecastStr : jsonWeatherData)
                {
